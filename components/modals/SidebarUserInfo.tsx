...
export default function SidebarUserInfo() {
    ...
    return (
        <div
            className="mt-auto xl:pt-6 flex items-center justify-start space-x-2 p-6 xl:pe-6 hover:bg-gray-500 hover:bg-opacity-10 rounded-full transition cursor-pointer w-fit xl:w-[240px]"
