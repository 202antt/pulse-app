...
export default function PostInput({ insideModal }: PostInputProps) {
    ...
    return (
        <div className="flex space-x-5 p-3 border-b border-gray-100">
            <Image
                src={insideModal ? "/assets/profile-icon.png" : "/assets/pulse.png"}
                width={44}
                height={44}
            ...
            <div className="w-full">
                ...
                <div className="flex justify-between pt-5 border-t border-gray-100">
                    <div className="flex space-x-1.5">
                        <PhotoIcon className="w-[22px] h-[22px] text-[#C40E4C]" />
                        <ChartBarIcon className="w-[22px] h-[22px] text-[#C40E4C]" />
                        <FaceSmileIcon className="w-[22px] h-[22px] text-[#C40E4C]" />
                        <CalendarIcon className="w-[22px] h-[22px] text-[#C40E4C]" />
                        <MapPinIcon className="w-[22px] h-[22px] text-[#C40E4C]" />
                        <div></div>

                        <button
                            className="bg-[#C40E4C] text-white w-[80px] h-[36px] rounded-full text-sm cursor-pointer disabled:bg-opacity-60"
                            disabled={!text}
